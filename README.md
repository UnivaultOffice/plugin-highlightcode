...
This repository is an archive of plugin-highlightcode. Now it moved to the marketplace repository [univaultoffice.github.io](https://github.com/UnivaultOffice/univaultoffice.github.io/tree/master/sdkjs-plugins/content).
